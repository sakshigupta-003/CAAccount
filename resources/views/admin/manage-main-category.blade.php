...
@section('title', 'Admin || Management main category')
@push('styles')
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.13.7/css/jquery.dataTables.min.css">
@endpush

@section('content')
@section('page', 'Management main category')

<div class="container pt-3 card">
    <div class="managers-section">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="m-0 fw-semi-bold">Management main category</h6>
            ...
            <form id="addAmenityForm">
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Enter main category Name" required>
...
@push('scripts')
    ...
    <script>
        ...
        function loadmanagers() {
            ...
            $.ajax({
                url: "{{ route('admin.main-category.get') }}",
                type: "GET",
        ...
        function addAmenity(e) {
            ...
            $.ajax({
                url: "{{ route('admin.main-category.save') }}",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,

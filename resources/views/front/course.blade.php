      ...
      <div class="courses-grid">
        ...
        <div class="course-card">
          ...
          <div class="course-content">
            ...
            <p class="course-description">Learn the fundamentals of Tally Prime accounting software, from basic entries to
        ...
        <div class="course-card">
          ...
          <div class="course-content">
            ...
            <p class="course-description">Master GST compliance, return filing, input tax credit, and latest updates in
              Indian taxation.</p>
            <div class="course-meta">
        ...
        <div class="course-card">
          ...
          <div class="course-content">
            ...
            <p class="course-description">Master the art of accounting, financial statements, ledgers, and real-world
              bookkeeping.</p>
            <div class="course-meta">
        ...
        <div class="course-card">
          ...
          <div class="course-content">
            ...
            <p class="course-description">Understand cost allocation, variance analysis, and management accounting
              principles for effective financial decision-making.</p>
            <div class="course-meta">
              <span><i class="fas fa-clock"></i> 8 weeks</span>
              <span><i class="fas fa-users"></i> Intermediate</span>
            </div>

...
.related-btn:active {
    background: #0f53ab;  /* darker blue for click feedback */
    color: white;
...
.related-card:nth-child(1) { --i: 1; }
.related-card:nth-child(2) { --i: 2; }
.related-card:nth-child(3) { --i: 3; }
</style>
@endpush
    ...
    <div class="related-grid">
      ...
      <div class="related-card">
        ...
        <div class="related-card-content">
          ...
          <a href="{{ route('course.detail', $relCourse['id']) }}" class="related-btn">View Course <i class="fas fa-arrow-right"></i></a>
        </div>
      </div>
      @endforeach
    </div>

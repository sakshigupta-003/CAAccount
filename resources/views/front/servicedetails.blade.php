        ...
        <div class="service-details-grid">
            ...
            <div class="service-details-sidebar">
                <div class="service-info-card">
                    ...
                    <button class="enroll-btn" onclick="window.location.href='{{ route('service.enroll', $service->id) }}'">
        ...
        <div class="related-grid">
            ...
            <div class="related-card">
                ...
                <div class="related-card-content">
                    ...
                    <a href="{{ route('service.detail', $relService['id']) }}" class="related-btn">View Service <i class="fas fa-arrow-right"></i></a>
                </div>
            </div>
            @endforeach
        </div>
